 ...
 * @brief Enumeration of clock sources which can possibly be used as reference for the USB High-Speed PLL.
 */
typedef enum
{
    USB2REF_CLK_SRC_UNKNOWN = 0x00,                     /**< Unknown clock source. */
    USB2REF_CLK_SRC_ECO     = 0x01,                     /**< Clock generated by External Crystal Oscillator (ECO) */
    USB2REF_CLK_SRC_EXT_CLK = 0x02                      /**< External clock input. */
